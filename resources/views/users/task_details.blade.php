                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="d-flex align-items-center justify-content-between flex-column flex-lg-row">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <a target="_blank" href="https://www.facebook.com/" style="font-size: 24px; color: #1877f2">
                                        <i class="fa-brands fa-facebook"></i>
                                    </a>
                                    <a target="_blank" href="https://twitter.com/" style="font-size: 24px; color: #14171a">
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-12 col-lg-6 d-flex flex-column justify-content-center" style="background: #90c747;">
                                    <div class="date-time-wrapper" style="margin: 0 auto;">
                                        <div class="d-flex align-items-center justify-content-center" style="border-bottom: 2px solid #fff; color: #fff; padding-bottom: 6px;">
                                            Start Date:
                                            <p class="mb-0 ms-2">
                                                <b>Aug 31, 2023</b>
                                            </p>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-center" style="color: #fff; padding-top: 6px;">
                                            End Date:
                                            <p class="mb-0 ms-2">
                                                <b>Sep 31, 2023</b>
                                            </p>
                        ...
                        <div class="col-12">
                            <form id="task-form">
                                @csrf
                                <div class="mb-3">
                                    <label for="formFile" class="form-label">Attachment<span class="text-danger">*</span></label>
                                ...
                                <div class="form-floating mb-3">
                                    <textarea name="comments" class="form-control" placeholder="Leave a comment here" id="comment" style="height: 100px"></textarea>
                                    <label for="comment">Comments<span class="text-danger">*</span></label>
                                    <span class="text-danger" id="comments_error"></span>
                                </div>
                                <div class="form-floating mb-3">
                                    <label for="comment">Google Drive Link (If the file is more big then Admissible size)</label>
